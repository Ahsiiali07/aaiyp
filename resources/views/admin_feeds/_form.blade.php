@if(isset($item))
    {!! Form::open(['url' => route('admin-feed-update', $item['id']), 'class'=> 'ajax', 'method' => 'feed', 'id' => 'update-admin_feed-form']) !!}
@else
    {!! Form::open(['url' => route('admin-feed-store'), 'class'=> 'ajax', 'method' => 'feed', 'id' => 'create-admin_feed-form']) !!}
@endif
<div class="row">
    {{ csrf_field() }}
